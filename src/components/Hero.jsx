...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(14% 0%, 72% 0%, 90% 100%, 0% 90%)",
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <h1 className="special-font uppercase font-zentry-regular  text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] absolute bottom-5 right-5 z-40 text-blue-100">
          G<b>a</b>ming
        </h1>
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-17 px-5 sm:px-10">
            <h1 className="special-font uppercase font-zentry-regular font-black text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] text-blue-100">
              redefi<b>n</b>e
            </h1>
      ...
      <h1 className="special-font uppercase font-zentry-regular  text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] absolute bottom-5 right-5  text-black">
        G<b>a</b>ming
      </h1>
    </div>
  );
